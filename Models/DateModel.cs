...
public class DateModel : ICloneable, IValidation
{
    ...
    object ICloneable.Clone() => new DateModel() { StartYear = this.StartYear, StartMonth =this.StartMonth, NotFinished = this.NotFinished , EndYear = this.EndYear, EndMonth =this.EndMonth };
